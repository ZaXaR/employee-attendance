<section class="max-w-xl">
    <header class="mb-6">
        <h2 class="text-lg font-semibold text-gray-800">{{ __('Update Password') }}</h2>
    ...
    <form method="post" action="{{ route('password.update') }}" class="grid gap-6">
        ...
        <div class="grid gap-2">
            ...
            <x-text-input id="password" name="password" type="password" class="w-full" autocomplete="new-password"
